...
public class EntregaEnOficinaResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the entrega value for this EntregaEnOficinaResponse.
     * 
     * @return entrega
     */
    ...
    /**
     * Sets the entrega value for this EntregaEnOficinaResponse.
     * 
     * @param entrega
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://pe.grupobbva.com/tat/ents/body/entregaEnOficina", "EntregaEnOficinaResponse"));
